  ...
  return (
    ...
    <div style={{ textAlign: 'center', backgroundColor: '#007bff', minHeight: '100vh' }}>
      <div className="blogs-page" style={{ padding: '20px' }}>
        <Link to="/HealthcareProviderMyBlogs" className="create-blog-btn" style={{ marginBottom:'30px', textDecoration: 'none', color: '#fff', backgroundColor: '#28a745', padding: '12px 24px', borderRadius: '6px', fontWeight: 'bold', marginTop: '30px', display: 'inline-block' }}>My Blogs</Link>
