  ...
  return (
    <div style={{ textAlign: 'center', backgroundColor: '#007bff', minHeight: '100vh', padding: '20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '100%', margin: '0 auto' }}>
        ...
        <Link to="/HealthcareProviderMyBlogs" style={{ color: '#28a745', textDecoration: 'none', marginTop: '10px' ,backgroundColor: '#ffff', padding: '12px 24px', borderRadius: '6px', border: 'none', cursor: 'pointer' }}>Go Back to My Blogs</Link>
      </div>
      {openAlert && (
