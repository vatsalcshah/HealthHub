    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ul className="nav">
            ...
            <CustomLink to="/PharmacistProfile" className="nav-link">
            ...
            <li>
                <li className="nav-item"><CustomLink to="/PharmacistPrescriptionForm" className="nav-link">Prescription Managment</CustomLink></li>
                <li className="nav-item"><CustomLink to="/PharmacistPersonalRecords" className="nav-link">Patient History</CustomLink></li>
            </li>
