    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ul className="nav">
            ...
            <li>
                <li className="nav-item"><CustomLink to="/PrescriptionForm" className="nav-link">Add Prescriptions</CustomLink></li>
                <li className="nav-item"><CustomLink to="/ManageAppointments" className="nav-link">Manage Appointments</CustomLink></li>
                <li className="nav-item"><CustomLink to="/PersonalRecords" className="nav-link">Patient Health Records</CustomLink></li>
                <li className="nav-item"><CustomLink to="/HealthcareProviderCommunity" className="nav-link">Community</CustomLink></li>
                <li className="nav-item"><CustomLink to="/HealthcareProviderDashboard" className="nav-link">Analytics</CustomLink></li>
