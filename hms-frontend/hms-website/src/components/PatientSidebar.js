...
export default function PatientSidebar() {
  ...
  return (
    <div>
      ...
      <CustomLink to="/PatientProfile" className="nav-link">
      ...
      <CustomLink to="/HealthRecordPage" className="nav-link" >
          <span className="menu-title">Health Record</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/SymptomChecker" className="nav-link" >
          <span className="menu-title">Symptom Checker</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/MedicationReminder" className="nav-link" >
          <span className="menu-title">Medication Reminder</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      ...
      <li className="nav-item">
      <CustomLink to="/PatientPrescription" className="nav-link" >
